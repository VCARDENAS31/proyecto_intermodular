<?php
// ==========================================
// CONSOLAS - PÁGINA PRINCIPAL (TODAS LAS PLATAFORMAS)
// ==========================================
...
<body>
    ...
    <main>
            ...
            <div class="container p-4 mt-4">
                ...
                <div class="contenedor-slider">
                    ...
                    <div id="arrastrar-scroll" class="d-flex flex-nowrap gap-3 overflow-auto pb-3">
                        <?php
                        // Obtiene las últimas 8 consolas de PS5
        ...
        <!-- ====== SECCIÓN CONSOLAS XBOX SERIES X/S ====== -->
        <section id="consolas-xbox">
            <div class="container p-4">
                ...
                <div class="contenedor-slider">
                    ...
                    <div id="arrastrar-scroll" class="d-flex flex-nowrap gap-3 overflow-auto pb-3">
                        <?php
                        // Obtiene las últimas 8 consolas de Xbox
        ...
        <!-- ====== SECCIÓN CONSOLAS NINTENDO SWITCH ====== -->
        <section id="consolas-nintendo">
            <div class="container p-4">
                ...
                <div class="contenedor-slider">
                    ...
                    <div id="arrastrar-scroll" class="d-flex flex-nowrap gap-3 overflow-auto pb-3">
                        <?php
                        // Obtiene las últimas 8 consolas de Nintendo Switch

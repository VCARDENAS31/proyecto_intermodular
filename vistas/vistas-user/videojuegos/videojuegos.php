...
<head>
    ...
    <title>Viciogames | Videojuegos</title>
        ...
        <section id="videojuegos-ps5">
            <div class="container p-4 mt-4">
                <div class="mb-4 mb-md-5 justify-content-between align-items-center d-flex">
                    ...
                    <div class="d-md-none">
                        <h6 class="fw-bold mb-0">VIDEOJUEGOS PS5</h6>
                    </div>
        ...
        <section id="videojuegos-xbox">
            <div class="container p-4">
                <div class="mb-4 mb-md-5 justify-content-between align-items-center d-flex">
                    ...
                    <div class="d-md-none">
                        <h6 class="fw-bold mb-0">VIDEOJUEGOS XBOX SERIES X/S</h6>
                    </div>
                    <div class="d-none d-md-block">
        ...
        <section id="videojuegos-nintendo">
            <div class="container p-4">
                <div class="mb-4 mb-md-5 justify-content-between align-items-center d-flex">
                    ...
                    <div class="d-md-none">
                        <h6 class="fw-bold mb-0">VIDEOJUEGOS NINTENDO SWITCH</h6>
                    </div>
                    <div class="d-none d-md-block">

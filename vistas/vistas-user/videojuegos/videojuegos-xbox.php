...
<head>
    ...
    <title>Viciogames | Videojuegos Xbox</title>
    ...
    <main>
            ...
            <div id="carrusel-imagenes" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/imagenes/banner1-videojuegos-xbox.webp" class="d-block w-100"
                            alt="Banner videojuegos Xbox Series X/S">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/imagenes/banner2-videojuegos-xbox.webp" class="d-block w-100"
                            alt="Banner videojuegos Xbox Series X/S">
                    </div>
                </div>
        ...
        <section class="barra-filtro p-4 mb-5 shadow-lg">
            <form method="GET" class="row g-3 align-items-end justify-content-center">
                ...
                <div class="col-md-3 d-flex gap-2 align-items-end">
                    ...
                    <a href="videojuegos/xbox" class="btn btn-secondary w-100">Reset</a>
                </div>
            </form>
        </section>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 justify-content-center">
                ...
                // Consulta a la base de datos para obtener videojuegos de Xbox filtrados
                $productosXbox = obtenerJuegosPorPlataformaFiltrados(
                    $conexion,
                ...
                if (mysqli_num_rows($productosXbox) > 0) {

                    while ($fila = mysqli_fetch_assoc($productosXbox)) {
                        ?>
                        <!-- Tarjeta con clase "xbox" para estilos específicos de Xbox -->

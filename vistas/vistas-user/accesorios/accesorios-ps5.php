...
<head>
    ...
    <title>Viciogames | Accesorios de PS5</title>
    ...
    <main>
        ...
        <section class="barra-filtro p-4 mb-5 shadow-lg">
            <form method="GET" class="row g-3 align-items-end justify-content-center">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark p-3 w-100 shadow-lg">
                            <!-- Opciones de categoría específicas para PS5 -->
                            <li>
                ...
                <div class="col-md-3 d-flex gap-2 align-items-end">
                    ...
                    <a href="accesorios/ps5" class="btn btn-secondary w-100">Reset</a>
                </div>
            </form>
        </section>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 justify-content-center">
                <?php
                // Consulta a la base de datos para obtener accesorios de PS5 filtrados
